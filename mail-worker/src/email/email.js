...
export async function email(message, env, ctx) {
	...
	try {
		...
		// postal-mime supports Cloudflare EmailMessage.raw directly.
		// Avoid buffering the whole message into a JS string and avoid UTF-8
		// corruption when a multi-byte character is split across stream chunks.
